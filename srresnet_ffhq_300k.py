...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            lq_folder='/content/mmediting-master/dataset/train/GT',
            gt_folder='/content/mmediting-master/dataset/train/GT',
            pipeline=train_pipeline,
            scale=scale)),
    val=dict(
        type=val_dataset_type,
        lq_folder='/content/mmediting-master/dataset/val/LQ',
